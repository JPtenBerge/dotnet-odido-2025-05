...
public class Game
{
    ...
    internal Game(int id, string playerName, DateTime creationDate, bool isCompleted, string? winnerType, List<Character> characters, List<CombatLogEntry> combatLog)
    {
        Id = id;
        PlayerName = playerName;
